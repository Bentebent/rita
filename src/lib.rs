...
impl<'a> State<'a> {
    async fn new(window: &'a Window) -> State<'a> {
        ...
        //TODO: enumerate adapters to select the correct one depending on required hardware support for non WASM targets
        ...
        let shader = device.create_shader_module(wgpu::ShaderModuleDescriptor {
            ...
            source: wgpu::ShaderSource::Wgsl(
                include_str!("../data/shaders/tutorial_3.wgsl").into(),
            ),
        });
